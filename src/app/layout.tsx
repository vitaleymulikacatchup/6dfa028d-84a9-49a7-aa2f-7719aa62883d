...
export const metadata: Metadata = {
  title: "Bulochka - Сеть свежих пекарен в Украине | Стать партнером",
  description: "Присоединяйтесь к Bulochka - новой сети пекарен с свежей выпечкой, ароматным кофе и десертами. Откройте свою пекарню и станьте нашим партнером.",
  keywords: "пекарня, булочная, свежая выпечка, круассаны, кофе, франшиза, партнерство, Украина",
  metadataBase: new URL("https://bulochka.ua/"),
  alternates: {
    canonical: "https://bulochka.ua/"
  },
  openGraph: {
    title: "Bulochka - Сеть свежих пекарен в Украине",
    description: "Откройте свою пекарню с Bulochka. Свежая выпечка, кофе и полная поддержка партнеров по всей Украине.",
    url: "https://bulochka.ua/",
    siteName: "Bulochka",
    images: [{
      url: "https://images.pexels.com/photos/6314908/pexels-photo-6314908.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Современная пекарня Bulochka"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Bulochka - Сеть свежих пекарен в Украине",
    description: "Откройте свою пекарню с Bulochka. Свежая выпечка и полная поддержка партнеров.",
    images: ["https://images.pexels.com/photos/6314908/pexels-photo-6314908.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
